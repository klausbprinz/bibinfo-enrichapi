...
class Marc21MdIdentifier(BaseModel):
    ...
    idType: Literal["isbn", "issn", "other", "systemId", "primaryBib", "almaBib"] | None = Field(
        default=None, 
        description="Type of ID: isbn (020a), issn (022a), other (024a), systemId (035a), primaryBib (009), almaBib (001)"
    )
