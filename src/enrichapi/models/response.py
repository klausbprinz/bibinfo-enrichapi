...
from .otherAPIs import BookCoverOpenLibrary
from .otherAPIs import DescriptionGoogleBooks
...
class OenbResponse(BaseModel):
    ...
    basicMarc21MD: BasicMarc21MD | None = Field(description="Basic Marc21 metadata")
